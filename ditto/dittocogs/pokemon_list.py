...
from dittocogs.json_files import FORMS
...
emotes = [
    "<a:load1:1023352847900868699>", 
    "<a:load3:1023352850690089040>",
    "<a:load4:1023352845535281202>",
    "<a:yeah:1023932665889554504>",
    "<a:load7:1023932670742376468>",
    "<a:load3moshed0926072432:1023932663322640416>",
    "<a:load4:1023932489783328849>",
    "<a:load7:1023932670742376468>", 
]
...
async def tr(text: str, variables):
    ...
    try:
        variables["ctx" if "ctx" in variables else "message"]
    except:
